...
\begin{example}
    ...
    Since the first preconditions to meet is $on(c, b)$ the only action capable is $stack(c, b)$. All the preconditions of $stack(c, b)$ are less critical than the current threshold, 
